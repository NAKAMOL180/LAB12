...
int calScore(int x,int y,int z){
	playerScore = cardNames[i] + cardNames[i] + cardNames[i];//Write the function to calculate the score with is the rightmost digit of summation of the scores from three cards.
	return playerScore;//Return the score. 
}
...
int main(){	
	...
	int yugiCards[3] = {drawYugi(),drawYuki(),0};
	srand(time(0));
